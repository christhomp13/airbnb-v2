...
function Header({ placeholder }) {
    ...
    return (
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10">
            {/* replacing the div with the header tag is key for optimization */}
            {/* sticky sticks the header to the top on scroll */}
            {/* z-50 prioritizes this page on the front of z-1 for example */}
            ...
            <div onClick={() => router.push("/")} className='relative flex items-center h-10 cursor-pointer my-auto'>
                ...
                <Image 
                    ...
                    layout="fill"
                    // layout uses up maximum space of container
                    objectFit="contain" 
                    // stops image from changing aspect ratio
                    objectPosition="left"
                    // assigns to left side of container
                />
            </div>
            ...
            {searchInput &&(
                <div className='flex flex-col col-span-3 mx-auto '>
                    ...
                    <div className='flex items-center border-b mb-4'>
                        <h2 className="test-2xl pl-2 flex-grow font-semibold">Number of Guests</h2>
